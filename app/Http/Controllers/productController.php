...
class productController extends Controller
{
    ...
    public function getAllProduct(Request $request ,$cat1,$cat2=null,$cat3=null)
    {
       ...
       // $products = $products->get();
        ...
        return view('products')->with(['products' =>$products  , 'catagory' => $cat ,'avalablefilter' =>$availablefilter ,
            'avaliblefiltervalue' => $availablefilterfiltervalue,'requestold'=> $request ] );//,'translateCatagory' => $translateCatagory
...
//---------------------
    ...
    public function productsContinue(Request $request)
    {
       ...
       return view('createProductContinue')->with([
            'name' => $request->name ,
            ...
            'catagory3' => $request->catagory3 ,
            'company_i18n' => $request->company_i18n ,
            'company' => $request->company ,
            'available' => $request->available ,
            'featuers_i18n' => $request->featuers_i18n ,
            'featuers' => $request->featuers ,
            'chkmostpopular' => $request->chkmostpopular ,
            'mostpopular' => $request->mostpopular ,
            'filter' => $request->filter ,
           'filtervalues' => $f ,
           'path_image' => $path_image,
           'path_mostpopular' => $path_mostpopular,
           ]);
    }
    public function editproductsContinue(Request $request)
    {
        $validated = $request->validate([
            'name'            =>       'required |string ',
            'price'           =>       'numeric',
        ...
        if( ! isset($request->image ))
        {
            ...
            if($counter == $imagepresent)
                 ...
                 return redirect()->back()->withErrors(['image' =>__('generic.require_one_image')]);
                //return 'no_image';
        }
        ...
        return view('editProductContinue')->with([
            'aboutProduct' => $request->aboutProduct,
            'aboutProduct_i18n' => $request->aboutProduct_i18n ,
            'id' => $request->id ,
            'name' => $request->name ,
            'name_i18n' => $request->name_i18n ,
            'price' => $request->price ,
    ...
    public function createProductContinue(Request $request)
    {
        return view('createProductContinue');
    }
    public function saveaboutproduct(Request $request)
    {
       $about = $request->aboutProduct_i18n;
        ...
        $trans = json_decode($request->input('aboutProduct_i18n'), true);
        $translations = [];
        $translations[] =['aboutProduct' => $data->setAttributeTranslations('aboutProduct', $trans)];
        dd($translations);
       // $translations['aboutProduct'] = ['en' => $about->en];
        // Save translations
    ...
    public function takmilkharid($id)
    {
        ...
        $productfortakmil->status = __('generic.compelete_buy');
        $productfortakmil->save();
        return   redirect()->route("voyager.sales.index")->with([
            'message'    =>__('generic.message_complete_buy')  ,
            'alert-type' => 'success',
        ]);
    }
}
