...
@section('content')
    ...
    <div class="container bg-white mt-3">
        <div class="row justify-content-center">
            <div class="col-4">
                <h3 class="text-center  border text-danger">{{__('generic.register_address_reciver')}}</h3>
            </div>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="col-lg-8 offset-2">
                        <div class="card mb-3">
                            ...
                            <div class="card-body text-right shadow">
                                ...
                                <form method="post" action="{{url('/pardakht')}}" enctype="multipart/form-data" id="pardakhtform">
                                    @csrf
                                        ...
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                ...
                                                <input class="form-control" type="text" placeholder="" name="kodemelli" pattern="\d{10}"
                                                       value= "{{Auth::user()->kodemelli}}" onkeyup="checkMelliCode(this)"
                                                       oninvalid="setCustomValidity('{{__('generic.error_kodemelli')}}')"
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class=" btn btn-danger" name="saveAdressdetail" value="{{__('generic.confirm_and_pay')}}">
                                    </div>
                                </form>
                                    <div class="form-group">
                                        <a class="btn btn-dark " href="/sabadKharid">{{__('generic.back')}}</a>
...
@section('title',__('generic.continue_pay'))
@endsection
