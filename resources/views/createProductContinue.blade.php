    ...
    <div class="page-content edit-add container-fluid">
        <div class="row">
            <form  method="post" action="/admin/products"   enctype="multipart/form-data" id="createproductform" class="form-edit-add">
                ...
                @if(isset($path_mostpopular))
                    <input type="hidden" name="chkmostpopular" value="{{$chkmostpopular}}">
                    <input type="hidden" name="mostpopular" value="{{$path_mostpopular}}">
                @endif
                 @if(isset($filter ) )
                ...
                <div class="col-md-12">
                    ...
                    <input type="hidden"
                           ...
                           @if(!empty(session()->getOldInput('aboutProduct_i18n') ))
                           value="{{ session()->getOldInput('aboutProduct_i18n') }}"
                           @else
                           value="{{ get_field_translations(New \App\Product(), 'aboutProduct') }}"
                        @endif>
