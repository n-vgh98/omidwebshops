                    ...
                    <div id="mySidepanel" class="sidepanel">
                        ...
                        <form method="post" class="p-2" style="direction: ltr">
                            <div class=" my-3 " style="border: solid; padding: 2%;color: white;">
                                <label for="customrangeprice" style="font-size: large;" > {{__('generic.price')}}</label>
                                <div class="position-relative">
                                    <span class="position-absolute overflow-hidden rangelable" style="right:80%;top: 40%;font-size: small; padding-top: 5%;"> {{__('generic.vahed_pool')}}1</span>
                                    <span class="position-absolute rangelable" style="right:0;top: 40%;font-size: small;padding-top: 5%;">{{number_format(20000000)}}{{__('generic.vahed_pool')}}</span>
