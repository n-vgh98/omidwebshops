...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{__('generic.register_new_user')}}</div>
                <p style="font-size:small;color: red;padding-{{__('generic.is_rtl') == 'true' ? 'right' : 'left'}}: 5px">{{__('generic.required_item')}}</p>
                <div class="card-body">
