        ...
        <nav class="navbar navbar-dark align-items-start sidebar  sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column justify-content-start p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active text-right" href="{{url('address')}}"><i class="fa fa-user"></i><span class="mr-1">جزئیات آدرس</span></a></li>
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link text-right" href="{{url('logout')}}"><i class="fa fa-home"></i><span class="mr-1">محصولات مناسب شما</span></a></li>
