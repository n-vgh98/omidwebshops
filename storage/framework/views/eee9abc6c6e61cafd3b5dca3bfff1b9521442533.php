                                        ...
                                        <?php $__currentLoopData = $dataType->browseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif(($row->type == 'select_dropdown' || $row->type == 'radio_btn') && property_exists($row->details, 'options')): ?>
                                                    <?php if($row->field =='status' ): ?>
                                                        <?php if($data->{$row->field} == 0): ?>
                                                            <span class=" btn bg-danger"> <?php echo __('generic.wait_confirm') ?? ''; ?></span>
                                                        <?php else: ?>
                                                            <span class=" btn bg-success"> <?php echo __('generic.confirmed')?? ''; ?></span>
                                                        <?php endif; ?>
                                                    <?php else: ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel2lang\vendor\tcg\voyager\src/../resources/views/comments/browse.blade.php ENDPATH**/ ?>