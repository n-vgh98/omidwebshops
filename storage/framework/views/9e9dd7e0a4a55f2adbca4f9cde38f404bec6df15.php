        ...
        <div class="side-menu-container">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?php echo e(route('voyager.dashboard')); ?>">
                    ...
                    <div class="title"><?php echo e(Voyager::setting('admin.title', 'داشبرد')); ?></div>
                </a>
            </div><!-- .navbar-header -->
...
<?php /**PATH F:\xampp\htdocs\shop-laravel\vendor\tcg\voyager\src/../resources/views/dashboard/sidebar.blade.php ENDPATH**/ ?>