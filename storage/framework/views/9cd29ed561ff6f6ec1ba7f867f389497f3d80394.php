            ...
            <?php if(isset($view) && ($view == 'browse' || $view == 'read')): ?>
                ...
                <?php if($view == 'browse'): ?>
                    ...
                    <?php else: ?>
                        ...
                        <input type="hidden"
                               data-i18n="true"
                               name="<?php echo e('value'.$row->id); ?>_i18n"
                               id="<?php echo e('value'.$row->id); ?>_i18n"
                               value="<?php echo e($encodedjson); ?>">
                       <p><?php echo e($value['fa']); ?></p>
                    <?php endif; ?>
                <?php else: ?>
                    <?php if(empty($selected_values)): ?>
                        <p><?php echo e(__('voyager::generic.no_results')); ?></p>
                    <?php else: ?>
                        <input type="hidden"
                               ...
                               id="<?php echo e('value'.$row->id); ?>_i18n"
                               value="<?php echo e($encodedjson); ?>">
                            <?php  $exteractedval = explode(',',$value['fa'])?>
                                <li> </li>
                    <?php endif; ?>
                <?php endif; ?>
            <?php else: ?>
                ...
                <input type="hidden"
                       data-i18n="true"
                       name="<?php echo e('value'); ?>_i18n"
                       id="<?php echo e('value'); ?>_i18n"
...
<?php endif; ?>
<?php /**PATH F:\xampp\htdocs\shop-laravel2lang\resources\views/vendor/voyager/filters/relationship.blade.php ENDPATH**/ ?>