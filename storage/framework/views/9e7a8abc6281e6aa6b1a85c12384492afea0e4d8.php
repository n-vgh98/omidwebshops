        ...
        <nav class="navbar navbar-dark align-items-start sidebar  sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column justify-content-start p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link text-right" href="<?php echo e(url('logout')); ?>"><i class="fa fa-home"></i><span class="mr-1">محصولات مناسب شما</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link text-right" href="#"><i class="fas fa-sign-out-alt"></i><span class="mr-1">خروج</span></a></li>
                </ul>

            </div>
        </nav>
        <div class="d-flex  justify-content-end" id="content-wrapper">
            <div id="content">
                                ...
                                <div class="card-body text-right shadow">
                                    ...
                                    <form method="post" action="<?php echo e(url('address')); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col">
                                                <div class="form-group text-right"><label for="last_name"><strong>شماره موبایل</strong></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel\resources\views/profile/address.blade.php ENDPATH**/ ?>