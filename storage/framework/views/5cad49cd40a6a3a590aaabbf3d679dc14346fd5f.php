        ...
        <nav class="navbar navbar-dark align-items-start sidebar  sidebar-dark accordion bg-gradient-danger p-0">
            <div class="container-fluid d-flex flex-column justify-content-start p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active text-right" href="<?php echo e(url('cartUser')); ?>"><i class="far fa-user-circle"></i><span class="mr-1">خرید های شما</span></a></li>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(($sal->price)-($sal->price * $sal->takhfif/100)); ?></td>
                                                    <td><?php echo e($sal->number); ?></td>
                                                    <td><?php echo e(($sal->price)-($sal->price * $sal->takhfif/100)* $sal->number); ?></td>
                                                    <td><?php echo e($sal->create_at); ?></td>
                                                    <td><?php echo e($sal->transId); ?></td>
                                                    <td><?php echo e($sal->catagory1); ?></td>
                                                </tr>
                                        </tbody>
                                    </table>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel\resources\views/profile/cartUser.blade.php ENDPATH**/ ?>