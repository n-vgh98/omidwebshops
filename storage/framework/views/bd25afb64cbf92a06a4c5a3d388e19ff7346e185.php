<?php $__env->startSection('title','ادامه پرداخت'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container bg-white mt-3">
        <div class="row justify-content-center">
            <div class="col-4">
                <h3 class="text-center  border text-danger">ثبت آدرس گیرنده</h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-6 my-2">
                <div class="form-group">
                    <a class="btn btn-dark " href="/sabadKharid"> بازگشت</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-lg-8 offset-2">
                        <div class="card mb-3">
                            <div class="card-header text-center bg-info">جزئیات آدرس</div>
                            <div class="card-body text-right shadow">
                                ...
                                <form method="post" action="<?php echo e(url('/pardakht')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-right">
                                                <label for="first_name"><strong>نام و نام خانوادگی گیرنده </strong>*</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-right">
                                                <label for="first_name"><strong>کد ملی گیرنده</strong>*</label>
                                        ...
                                        <div class="col">
                                            <div class="form-group text-right">
                                                <label for="first_name"><strong>شماره موبایل</strong>*</label>
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class=" btn btn-danger" name="saveAdressdetail" value="تأیید و پرداخت ">
                                    </div>
                                </form>
                                    <div class="form-group">
                                        <a class="btn btn-dark " href="/sabadKharid"> بازگشت</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel\resources\views/continuePardakht.blade.php ENDPATH**/ ?>