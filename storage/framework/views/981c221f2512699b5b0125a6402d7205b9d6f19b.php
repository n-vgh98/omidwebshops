                                    ...
                                    <div class="card-body text-<?php echo e(__('generic.text_direction')); ?> shadow">
                                        ...
                                        <form method="post" action="<?php echo e(url('address')); ?>"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="col">
                                                    <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="" name="kodemelli" value= "<?php echo e(Auth::user()->kodemelli); ?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <input type="submit" class=" btn btn-danger" name="saveAdressdetail" value="<?php echo e(__('generic.save')); ?>">
                                            </div>
                                        </form>
                                        <div class="form-group">
...
<?php $__env->startSection('title',__('generic.detail_address') ); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel2lang\resources\views/profile/useraddress.blade.php ENDPATH**/ ?>