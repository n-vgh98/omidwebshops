...
<div class="languag   <?php if (__('generic.is_rtl') == 'true') echo 'ltr'; else echo 'rtl' ?>">
    <a href="<?php echo e(url('fa')); ?> " class="p-1" style="background-color: #1cc88a">Fa</a><a class="p-1"
                                                                                    style="background-color: #dc3545"
                                                                                    href="<?php echo e(url('en')); ?> ">En</a>
</div>
<div class="container-fluid">
    <div class="row">
        <div class="col-2">
            <div class="">
                <a href="/" title="لوگو">
                    <img src="<?php echo e(asset('images/shortcutIcon.png')); ?>" alt="<?php echo e(__('generic.logo')); ?>"
        ...
        <div class="col-6">
            <div class="searchBox  mt-4  mr-auto ">
                <form class="form-inline" action="<?php echo e(url('search')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <input class="form-control p-2 ml-2 rounded " type="search" placeholder="<?php echo e(__('generic.search')); ?>"
                           size="40" onFocus="" name="valueSearch">
                    ...
                    <?php if(\Illuminate\Support\Facades\Auth::check()): ?>
                        ...
                        <div class="dropdown  profile" role="presentation">
                            ...
                            <a class="dropdown-toggle no-arrow" data-toggle="dropdown" aria-expanded="true" href="#">
                                <span
                                    class="d-none d-lg-inline  text-secondary small"><?php echo e(\Illuminate\Support\Facades\Auth::user()->name); ?></span>
                                <img class="border rounded-circle img-profile" width="60px0" height="60px"
                                     src="<?php echo e(asset('storage/'.\Illuminate\Support\Facades\Auth::user()->avatar)); ?>">
                            </a>
                            <div class="dropdown-menu shadow   dropdown-menu-animated  border-secondary " role="menu"
                                 style="z-index: 111111111" id="profileBlock">
                                ...
                                <a class="dropdown-item text-right" role="presentation" href="<?php echo e(url('sabadKharid')); ?>">
                                    <i class="fas fa-shopping-basket fa-sm fa-fw text-gray-400"></i>&nbsp; <?php echo e(__('generic.bag_cart')); ?>

                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item text-right text-danger" role="presentation"
                                   href="<?php echo e(route('logout')); ?>"><i
                                        class="fas fa-sign-out-alt fa-sm fa-fw  text-gray-400"></i>&nbsp;<?php echo e(__('generic.exit')); ?>

                                </a>
                            </div>
                        </div>
                    <script>document.getElementById("btnVorod").style.display="none";</script>
                        
                    <?php else: ?>
                        <a class="btn btn-outline-primary text-dark ml-auto " value="ورود" name="btnLogin"
                           href="<?php echo e(route('login')); ?>"><?php echo e(__('generic.login')); ?></a>
                    <?php endif; ?>
                </div>
                <div class="divider" style="padding: 13px;"></div>
                <a href="/sabadKharid">
                    <div
                        class="d-lg-flex d-xl-flex justify-content-lg-center align-items-lg-center justify-content-xl-center align-items-xl-center">
        ...
        <ul class="navbar-nav nav-pills">
            ...
            <div class="col-xl-2 col-lg-3 p-0 text-center">
                ...
                <div class="dropdown divLi">
                    ...
                    <div class="dropdown-content shadowBaxs andazeTagAHa"
                         style="background-image: url('./pic/3.jpg');background-size: cover;background-repeat: no-repeat;">
            ...
            <?php $__currentLoopData = $root; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <li class="nav-item dropdown position-static">
                    <a class="nav-link" <?php if($item->name == __('generic.home')): ?> href="/"
                       <?php else: ?> href="/product/catagory/<?php echo e($item->name); ?>" <?php endif; ?> id="menu1dropdown">
                                ...
                                <div class="row ">
                                    <?php $__currentLoopData = $cat1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemcat1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-<?php echo e($col); ?> p-1">
                                            <a href="/product/catagory/<?php echo e($item->name); ?>/catagory/<?php echo e($itemcat1->name); ?>"
                                               style="text-decoration: none">
                                                <h6 class="dropdown-header text-center"><?php echo e($itemcat1->name); ?></h6></a>
                                            <div class="dropdown-divider"></div>
                                            <?php
                                                $id = $itemcat1->id;
                                            ...
                                            <?php $__currentLoopData = $cat2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a class="dropdown-item  text-center"
                                                   href="/product/catagory/<?php echo e($item->name); ?>/catagory/<?php echo e($itemcat1->name); ?>/catagory/<?php echo e($cat2->name); ?>"><?php echo e($cat2->name); ?></a>
...
<?php /**PATH F:\shop-laravel2lang\resources\views/header.blade.php ENDPATH**/ ?>