        ...
        <div class="row">
            ...
            <div class="col-sm-2 col-4  overflow-hidden" >
                <div class="range my-4 bg-white">
                        ...
                        <label for="customrangeprice"> <?php echo e(__('generic.price')); ?></label>
                        <div class="position-relative">
                            <span class="position-absolute overflow-hidden rangelable" style="right:80%;top: 40%;font-size: small"> <?php echo e(__('generic.vahed_pool')); ?>1</span>
                            <span class="position-absolute rangelable" style="right:0;top: 40%;font-size: small"><?php echo e(number_format(20000000)); ?><?php echo e(__('generic.vahed_pool')); ?></span>
                            ...
                            <div class=" my-3">
                                <div style="cursor: pointer;" id="filtername<?php echo e($loop->iteration); ?>" onclick="togglefilter(<?php echo e($loop->iteration); ?>)">
                                    <div class="sidefilter p-2" for="">
                                        <?php echo e($af->getTranslatedAttribute('name')); ?> <span class="fa fa-caret-down float-<?php echo e(__('voyager::generic.is_rtl') == 'true' ? 'left' : 'right'); ?>" style="margin-left:1em;color:black"></span>
                                    </div>
                                </div>
                                           ...
                                           <div class="form-check">
                                               <label class="form-check-label mx-1">
                                                   ...
                                                   <?php
                                                       ...
                                                       ?>>
                                                   <?php echo e($afv->getTranslatedAttribute('value')); ?>
            ...
            <div class="col-sm-10 col-8">
                <?php if($products->count()>0): ?>
                    ...
                    <ul class="breadcrumb justify-content-lg-start">
                        <li class="breadcrumb-item  px-1"><a href="/"><span class="fa fa-home ml-1"></span><?php echo e(__('generic.home')); ?></a></li>
                        <?php if(isset($catagory)): ?>
                        <li class="breadcrumb-item px-1"><a href="/product/catagory/<?php echo e($catagory[0]['cat1']); ?>"><?php echo e($cat1_translated); ?></a></li>
                        <?php if($catagory[0]['cat2'] !=NULL): ?>
                            <li class="breadcrumb-item   px-1"><a href="/product/catagory/<?php echo e($catagory[0]['cat1']); ?>/catagory/<?php echo e($catagory[0]['cat2']); ?>"><?php echo e($cat2_translated); ?></a></li>
                        <?php endif; ?>
                        <?php if($catagory[0]['cat3'] !=NULL): ?>
                        <li class="breadcrumb-item   px-1"><a href="/product/catagory/<?php echo e($catagory[0]['cat1']); ?>/catagory/<?php echo e($catagory[0]['cat2']); ?>/catagory/<?php echo e($catagory[0]['cat3']); ?>"><?php echo e($cat3_translated); ?></a></li>
                        <?php endif; ?>
                            <?php endif; ?>
                    </ul>
...
<?php $__env->startSection('title', $cat1_translated); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel2lang\resources\views/products.blade.php ENDPATH**/ ?>