...
<div class="container-fluid">
    <div class="row">
        <div  class="col-2">
            <div class="">
            <a href="/" title="لوگو" >
                <img src="<?php echo e(asset('images/shortcutIcon.png')); ?>" alt="لوگو فروشگاه اینترتی"  class="img-fluid my-auto"/>
                </a>
            </div>
        </div>
        <div class="col-6">
                    ...
                    <?php if(\Illuminate\Support\Facades\Auth::check()): ?>
                        ...
                        <div class="dropdown  profile" role="presentation">
                                ...
                                <div class="dropdown-menu shadow   dropdown-menu-animated  border-secondary " role="menu" style="z-index: 111111111" id="profileBlock">
                                    ...
                                    <a class="dropdown-item text-right" role="presentation" href="<?php echo e(url('sabadKharid')); ?>"><i class="fas fa-shopping-basket fa-sm fa-fw text-gray-400"></i>&nbsp;سبد خرید</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item text-right text-danger" role="presentation" href="<?php echo e(route('logout')); ?>"><i class="fas fa-sign-out-alt fa-sm fa-fw  text-gray-400"></i>&nbsp;خروج</a>
                                </div>
                        </div>
                        
                    <?php else: ?>
                     <a  class="btn btn-outline-primary text-dark ml-auto " value="ورود" name="btnLogin" href="<?php echo e(route('login')); ?>">ورود</a>
                   <?php endif; ?>
                </div>
     ...
     <div class="collapse navbar-collapse" id="menu1">
        ...
        <ul class="navbar-nav nav-pills">
        	...
        	<li class="nav-item dropdown position-static">
            	<a class="nav-link"  <?php if($item->name == 'صفحه اصلی'): ?> href="/" <?php else: ?> href="/product/catagory/<?php echo e($item->name); ?>" <?php endif; ?> id="menu1dropdown"><?php echo e($item->name); ?></a>
                <?php
                    $id = $item->id;
...
<?php /**PATH F:\xampp\htdocs\shop-laravel\resources\views/header.blade.php ENDPATH**/ ?>