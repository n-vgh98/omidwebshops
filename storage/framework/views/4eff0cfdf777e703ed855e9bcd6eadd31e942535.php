...
<head>
    ...
    <title>Dashboard - خانومی</title>
    <meta name="description" content="پنل ادمین فروشگاه خانومی">
...
<body id="page-top">
    ...
    <footer class="bg-white sticky-footer">
        <div class="container my-auto">
            <div class="text-center my-auto copyright"><span>Copyright © خانومی 2019</span></div>
        </div>
    </footer>
