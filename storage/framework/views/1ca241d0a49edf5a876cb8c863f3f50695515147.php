                    ...
                    <ul class="nav nav-tabs">
                        <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li <?php if($group == $active): ?> class="active" <?php endif; ?>>
                                <a data-toggle="tab" href="#<?php echo e(\Illuminate\Support\Str::slug($group)); ?>"><?php echo e(__('voyager::generic.'.$group)); ?></a>
                            </li>
                        ...
                        <div id="<?php echo e(\Illuminate\Support\Str::slug($group)); ?>" class="tab-pane fade in <?php if($group == $active): ?> active <?php endif; ?>">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <?php echo e(__('voyager::settings.'.$setting->key)); ?> <?php if(config('voyager.show_dev_tips')): ?><?php endif; ?>
                                </h3>
                            ...
                            <div class="panel-body no-padding-left-right">
                                ...
                                <div class="col-md-2 no-padding-left-right" style="display: none">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel2lang\vendor\tcg\voyager\src/../resources/views/settings/index.blade.php ENDPATH**/ ?>