<?php $__env->startSection('content'); ?>
    ...
    <div class="container bg-white mt-3">
        <div class="row justify-content-center">
            <div class="col-4">
                <h3 class="text-center  border text-danger"><?php echo e(__('generic.register_address_reciver')); ?></h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-6 my-2">
                <div class="form-group">
                    <a class="btn btn-dark " href="/sabadKharid"> <?php echo e(__('generic.back')); ?></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid">
                ...
                <div class="row mb-3">
                    <div class="col-lg-8 offset-2">
                        <div class="card mb-3">
                            <div class="card-header text-center bg-info"><?php echo e(__('generic.detail_address')); ?></div>
                            <div class="card-body text-right shadow">
                                ...
                                <h6><?php echo e(__('generic.please_ernter_detail_address')); ?></h6>
                                <form method="post" action="<?php echo e(url('/pardakht')); ?>" enctype="multipart/form-data" id="pardakhtform">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" value="<?php echo e(old('pay')); ?>" name="pay" id="sumhidden">
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-right"><label for="first_name"><strong><?php echo e(__('generic.province')); ?></strong>*</label>
                                        ...
                                        <div class="col">
                                            <div class="form-group text-right"><label for="last_name"><strong><?php echo e(__('generic.city')); ?></strong>*</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name" class=""><strong><?php echo e(__('generic.neshan_posti')); ?></strong>*</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name"><strong><?php echo e(__('generic.pelak')); ?> </strong></label>
                                        ...
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name"><strong><?php echo e(__('generic.vahed')); ?></strong></label>
                                        ...
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name"><strong><?php echo e(__('generic.code_posti')); ?></strong>*</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name"><strong><?php echo e(__('generic.name_reciver')); ?></strong>*</label>
                                                <input class="form-control" type="text" placeholder="" name="namegirandeh" value= "<?php echo e(Auth::user()->name); ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name"><strong><?php echo e(__('generic.kode_melli')); ?></strong>*</label>
                                                <input class="form-control" type="text" placeholder="" name="kodemelli" pattern="\d{10}"
                                                       value= "<?php echo e(Auth::user()->kodemelli); ?>" onkeyup="checkMelliCode(this)"
                                                       oninvalid="setCustomValidity('<?php echo e(__('generic.error_kodemelli')); ?>')"
                                        ...
                                        <div class="col">
                                            <div class="form-group text-<?php if( __('generic.is_rtl') =='true') echo 'right'; else echo 'left';    ?>">
                                                <label for="first_name"><strong><?php echo e(__('generic.mobile')); ?></strong>*</label>
                                                <input class="form-control" type="text" placeholder="" name="mobile" value= "<?php echo e(Auth::user()->mobile); ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class=" btn btn-danger" name="saveAdressdetail" value="<?php echo e(__('generic.confirm_and_pay')); ?>">
                                    </div>
                                </form>
                                    <div class="form-group">
                                        <a class="btn btn-dark " href="/sabadKharid"><?php echo e(__('generic.back')); ?></a>
...
<?php $__env->startSection('title',__('generic.continue_pay')); ?>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel2lang\resources\views/continuePardakht.blade.php ENDPATH**/ ?>