...
<?php else: ?>
    ...
    <select class="form-control select2" name="<?php echo e($row->field); ?>">
        ...
        <?php if(isset($options->options)): ?>
            <?php $__currentLoopData = $options->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?php if($default == $key && $selected_value === NULL): ?> selected="selected" <?php endif; ?> <?php if($selected_value == $key): ?> selected="selected" <?php endif; ?>><?php echo e(($key == '0' && $dataType->slug =='comments')  ? __('generic.wait_confirm') : __('generic.confirmed')); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    </select>
<?php endif; ?>
<?php /**PATH F:\xampp\htdocs\shop-laravel2lang\vendor\tcg\voyager\src/../resources/views/formfields/select_dropdown.blade.php ENDPATH**/ ?>