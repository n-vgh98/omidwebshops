            ...
            <ol class="breadcrumb hidden-xs ">
                ...
                <?php else: ?>
                    ...
                    <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <?php if($loop->last): ?>
                            <?php if(is_numeric(urldecode($segment))): ?>
                                <a href="<?php echo e($url); ?>"><?php echo e(urldecode($segment)); ?></a>
                            <?php else: ?>
                            <li><?php echo e(__('voyager::navbar.'.urldecode($segment))); ?></li>
                            <?php endif; ?>
                        <?php else: ?>
                            <li>
                                <?php if(is_numeric(urldecode($segment))): ?>
                                    <a href="<?php echo e($url); ?>"><?php echo e(urldecode($segment)); ?></a>
                                <?php else: ?>
                                <a href="<?php echo e($url); ?>"><?php echo e(__('voyager::navbar.'.urldecode($segment))); ?></a>
                                    <?php endif; ?>
                            </li>
                        <?php endif; ?>
                ...
                <ul class="dropdown-menu dropdown-menu-animated">
                    ...
                    <li <?php echo isset($item['classes']) && !empty($item['classes']) ? 'class="'.$item['classes'].'"' : ''; ?>>
                        ...
                        <a href="<?php echo e(isset($item['route']) && Route::has($item['route']) ? route($item['route']) : (isset($item['route']) ? $item['route'] : '#')); ?>" <?php echo isset($item['target_blank']) && $item['target_blank'] ? 'target="_blank"' : ''; ?>>
                            ...
                            <i class="<?php echo $item['icon_class']; ?>"></i>
                            <?php endif; ?>
                            <?php echo e(__("generic.$item[alias_name]")); ?>
...
<?php /**PATH F:\xampp\htdocs\shop-laravel2lang\vendor\tcg\voyager\src/../resources/views/dashboard/navbar.blade.php ENDPATH**/ ?>