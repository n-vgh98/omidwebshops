...
<?php $__env->startSection('content'); ?>
    <div class="page-content edit-add container-fluid">
        <div class="row">
            <form  method="post"    action="<?php echo e(route('voyager.products.update',$id)); ?>"   enctype="multipart/form-data" id="createproductform" class="form-edit-add">
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\shop-laravel2lang\resources\views/editProductContinue.blade.php ENDPATH**/ ?>