...
return [
    ...
    'site.description'          => 'شرح مختصر فعالیت سایت' ,
    'site.logo'                 =>'لوگوی سایت' ,
    'site.google_analytics_tracking_id'  => 'شناسه گوگل انالیز' ,
    'admin.title'                => 'عنوان ادمین',
    'admin.description'          => 'توضیحات ادمین' ,
    'admin.loader'               =>'لودر ادمین' ,
    'admin.google_analytics_client_id' => 'شناسه گوگل انالیز (برای داشبورد ادمین مورد استفاده قرار می گیرد) ' ,
    'admin.icon_image'           => 'ایکن پنل ادمین' ,
    'admin.bg_image'             => 'تصویر پیش زمینه ادمین ' ,
