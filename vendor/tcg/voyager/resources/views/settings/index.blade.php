                    ...
                    <ul class="nav nav-tabs">
                        @foreach($settings as $group => $setting)
                            <li @if($group == $active) class="active" @endif>
                                <a data-toggle="tab" href="#{{ \Illuminate\Support\Str::slug($group) }}">{{ __('voyager::generic.'.$group) }}</a>
                            </li>
                        @endforeach
                    </ul>
                        ...
                        <div id="{{ \Illuminate\Support\Str::slug($group) }}" class="tab-pane fade in @if($group == $active) active @endif">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    {{ __('voyager::settings.'.$setting->key) }} @if(config('voyager.show_dev_tips'))@endif
                                </h3>
