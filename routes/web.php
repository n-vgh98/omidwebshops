...
Route::get('fa','langController@fa');
...
Route::get('message_user','userProfileController@messsage_user')->middleware('auth');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('/productsContinue','productController@productsContinue');
    Route::post('/editProductContinue','productController@editproductsContinue');
    Route::post('/createProductContinue','productController@createProductContinue')->name('');
    ...
    Route::get('/pasokh_user_message/{id}','messageController@user_message');
    Route::post('/pasokh_user_message/{id}','messageController@pasokh_user_message');
...
Route::get('ip','langController@test');
